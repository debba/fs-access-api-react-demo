...
const EditFile: React.FC<{ file: File, onClose: () => void }> = ({file, onClose}) => {
    ...
    return (
        <>
            <div className="w-full px-5 mx-auto flex bg-gray-900 h-10  items-center justify-between">
            ...
            <div className="mx-2">
                <h3 className="font-medium text-2xl text-gray-900 my-2">File Content</h3>
